...
(
 ...
 `CUST_IS_ADMIN` varchar(2) NOT NULL,
 `CUST_IS_BLOCKED` varchar(2) NOT NULL,
...
KEY `FK_LINE_CITY_NAME` (`CITY_NAME`),
CONSTRAINT `FK_LINE_CITY_NAME` FOREIGN KEY `FK_LINE_CITY_NAME` (`CITY_NAME`) REFERENCES `foodtastic`.`SALES_CITY` (`CITY_NAME`)
);
